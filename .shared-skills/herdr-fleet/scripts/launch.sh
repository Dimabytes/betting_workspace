...
P="You are agent '$N'. Read fully: $R/00-context.md, then $R/briefs/$N.md. Do the brief. Write the full report to $R/reports/$N.md (file, not chat; update it as you go). Scratch files go to $R/work/$N/. When done, reply with only the report path."
